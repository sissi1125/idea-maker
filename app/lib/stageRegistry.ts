...
const registry: StageDef[] = [
  ...
  },
  {
    ...
    methods: [
      {
        id: "openai-3-small",
        label: "OpenAI-compatible Embedding（OpenAI / Qwen / 其他）",
        params: [
          { key: "model", label: "模型", type: "text", default: "text-embedding-3-small", hint: "Qwen: text-embedding-v4，OpenAI: text-embedding-3-small" },
          { key: "dimension", label: "向量维度", type: "number", default: 1536, min: 64, max: 4096, hint: "留空则读取 EMBEDDING_DIMENSION 环境变量" },
          ...
          { key: "baseUrl", label: "API Base URL（可选）", type: "text", default: "", placeholder: "留空则读取 EMBEDDING_BASE_URL，Qwen: https://dashscope.aliyuncs.com/compatible-mode/v1" },
        ],
      },
      {
        id: "hf-tei-embedding",
